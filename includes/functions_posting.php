...
include_once $phpbb_root_path . '/spamFilter.php';
/**
...
{
	global $db, $auth, $user, $config, $phpEx, $phpbb_root_path, $phpbb_container, $phpbb_dispatcher, $phpbb_log, $request,$guest_spam;
	$guest_spam = false;
	if ($mode != 'edit'){
		$guest_spam = Spam_Filter($data_ary,$user,$subject,$username);
	};
	...
	*/
	...
	if (!$auth->acl_get('f_noapprove', $data_ary['forum_id']) || $guest_spam)
	{
